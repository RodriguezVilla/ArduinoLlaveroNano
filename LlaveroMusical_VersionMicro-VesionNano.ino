...
void escuchandoPulsadores(){
  ...
  if(!entroSoloUnaVez){
    sendCommand(CMD_PLAY_FOLDER_FILE, 0x0202);
  ...
  if(digitalRead(4)==LOW){
    ...
    delay(tmp);
    sendCommand(CMD_PLAY_FOLDER_FILE, 0x0103);
  }
    
  if(digitalRead(7)==LOW){
    Serial.println("Pulsado bt4");
    delay(tmp);
    sendCommand(CMD_PLAY_FOLDER_FILE, 0x0104);
  }
     
  if(digitalRead(8)==LOW){
    Serial.println("Pulsado bt5");
    delay(tmp);
    sendCommand(CMD_PLAY_FOLDER_FILE, 0x0105);
  ...
  if(digitalRead(9)==LOW){
    ...
    sendCommand(CMD_PLAY_FOLDER_FILE, 0x0106);
  } 
      
  if(digitalRead(10)==LOW){
    Serial.println("Pulsado bt7");
    delay(tmp);
    sendCommand(CMD_PLAY_FOLDER_FILE, 0x0107);
  }
     
  if(digitalRead(11)==LOW){
    Serial.println("Pulsado bt8");
    delay(tmp);
    sendCommand(CMD_PLAY_FOLDER_FILE, 0x0108);
  ...
  if(digitalRead(12)==LOW){
    ...
    delay(tmp);
    sendCommand(CMD_PLAY_FOLDER_FILE, 0x0109);
  } 
//
